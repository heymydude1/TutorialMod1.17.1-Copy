 ...
 */
package net.fabricmc.tutorial.util.entity;
...
public class ThorHammorTridentEntityRenderer
extends EntityRenderer<TridentEntity> {
    ...
    public ThorHammorTridentEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
