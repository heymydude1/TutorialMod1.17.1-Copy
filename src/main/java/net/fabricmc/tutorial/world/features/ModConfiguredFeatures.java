package net.fabricmc.tutorial.world.features;
...
public class ModConfiguredFeatures {
    ...
    public static RegistryKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(Main.MOD_ID, name));
    }
    ...
    private static ConfiguredFeature<TreeFeatureConfig, ?> register(String name,
        ...
        return Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(Main.MOD_ID, name),
                configuredFeature);
    }
    ...
    public static void registerConfiguredFeatures() {
        System.out.println("Registering ModConfiguredFeatures for " + Main.MOD_ID);
    }
}
