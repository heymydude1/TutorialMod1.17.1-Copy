package net.fabricmc.tutorial.entity;
...
public class ThorHammerTridentEntity extends MoreWeaponryTridentEntity {

    private boolean hasSearchedTarget;
    private Entity closestTarget;

    public ThorHammerTridentEntity(EntityType<? extends MoreWeaponryTridentEntity> entityType, World world) {
    ...
    public void setVelocity(LivingEntity user, float pitch, float yaw, float v, float v1, float v2) {
    }
}
