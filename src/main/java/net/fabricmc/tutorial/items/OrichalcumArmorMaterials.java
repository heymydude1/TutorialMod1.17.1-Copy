...
public enum OrichalcumArmorMaterials implements ArmorMaterial {
    ORICHALCUM("orichalcum", 18, new int[]{3, 5, 7, 2}, 29,
    ...
    private OrichalcumArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts,
