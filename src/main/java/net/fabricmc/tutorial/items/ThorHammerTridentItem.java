...
import net.fabricmc.tutorial.items.custom.MoreWeaponryTridentItem;
...
public class ThorHammerTridentItem
    ...
    public ThorHammerTridentItem(Item.Settings settings) {
        super(settings);
