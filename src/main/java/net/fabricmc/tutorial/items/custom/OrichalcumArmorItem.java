...
import net.fabricmc.tutorial.items.OrichalcumArmorMaterials;
...
public class OrichalcumArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(OrichalcumArmorMaterials.ORICHALCUM,
                            new StatusEffectInstance(StatusEffects.HASTE, 400, 1)).build();

    public OrichalcumArmorItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
